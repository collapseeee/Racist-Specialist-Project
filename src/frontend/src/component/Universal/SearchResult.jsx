                  ...
                  <table className="tournament-detail-ranking-table">
                      ...
                      {tournamentResults.map((tournament) => (
                          <tr key={tournament.tournament_id}>
                              <td>
                                  <Link to={`/Tournaments/${tournament.id}`} className="staff-link">
              ...
              {teamResults.length === 0 ? (
                  ...
                  <table className="tournament-detail-ranking-table">
                      ...
                      {teamResults.map((team) => (
                          <tr key={team.team_id}>
                              <td>
                                  <Link to={`/Tournaments/${team.team_id}`} className="staff-link">
                                      {team.team_name}
                                  </Link>
                              </td>
                              <td>Sponsor</td>
                    ...
                    <table className="tournament-detail-ranking-table">
                        ...
                        {racerResults.map((racer) => (
                            <tr key={racer.person_id}>
                                <td>
                                    <Link to={`/Teams/${racer.team_id}`} className="staff-link">
                                        {racer.team_name}
                                    </Link>
                                </td>
                  ...
                  <table className="tournament-detail-ranking-table">
                      ...
                      {carResults.map((car) => (
                          <tr key={car.carmodel_id}>
                              <td>
                                  <Link to={`/Cars/${car.carmodel_id}`} className="staff-link">
                                      {car.car_type}
                                  </Link>
                              </td>
                              <td>{car.engine}</td>
